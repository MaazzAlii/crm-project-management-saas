...
## In Progress
- [ ] TASK 10 — Core Database Schema: Communication Hub & Billing Tables
...
- `cc45a2c` — `feat(db): add tenant-scoped CRM/PM schema with communication-mode field`

## Deployment Status
- Migrations 0004 (`crm_clients` with `communication_mode` enum) and 0005 (`projects_tasks_deliverables` tenant-scoped tables with indexes) created and committed.
...
`TASK 10 — Core Database Schema: Communication Hub & Billing Tables`
(see `10-core-database-schema--communication-hub-and-billing.md`)
